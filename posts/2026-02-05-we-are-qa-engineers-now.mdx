...
What I've observed is that over the last year or so, the software development landscape has changed in a way that makes QA a central part of the software engineering workflow.
